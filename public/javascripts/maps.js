      ...
      process_it = function(doc) {
        ...
        for (var i=0; i<jsonData.markers.length; i++) {
          ...
          var chatHtml = '<div class="content"><div class="chat-box"><h3>' + jsonData.markers[i].chat + '</h3><div class="avatars">' + jsonData.markers[i].users + '</div><ul id="chatroom"></ul><input id="say" type="text"></input></div></div>';
